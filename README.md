...
3. 강의실 대여 및 좌석 예약을 위한 날짜 선택
  ...
  4-1. 교수님 페이지
    1. 강의실 선택 후 다음의 정보를 기입
      1-1. 시간은 1시간 단위로 스크롤바를 내려 선택할 수 있습니다.

    2. 정보가 제대로 기입되면 관리자에게 승인 요청이 전달되며 관리자 승인 후 해당 강의실 사용 가능

  4-2. 학생용 페이지

   1. 회의용/자습용 중 어떤 용도로 강의실을 이용할건지 선택

   2. 자습용 선택 후 원하는 강의실 선택 (회의용은 교수님 페이지와 같아 따로 캡쳐하지 않았습니다.)
     2-1. 하단의 숫자는 총 좌석 수를 나타내며 실제 앱 구동 시 잔여좌석이 앞에 표기됩니다.
      예) 29 / 36
   
   3. 강의실 선택을 다시 한 번 묻는 팝업창 실행 후 완전 선택되면 해당 좌석의 색이 변경되며 신청 완료 문구가 표시됩니다.
